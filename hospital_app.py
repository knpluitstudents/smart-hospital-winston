...
DEPT_INFO = {
    'Respiratory Medicine': {
        ...
        'desc':'Specialises in condetions affecting the lungs and airways',
...
st.markdown("""
<!-- COLOR1 -->
<div style="background:linear-gradient(135deg,#a2f606 0%,#4fff0a 60%,#c10cdd 100%);
...
with st.form("triage_form"):
    ...
    st.markdown("""
    <!-- COLOR2 -->
    <div style="background:#0050a0;border:1px solid #cbdc0d;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#e3f20a;color:white;border-radius:8px;
    ...
    <div style="background:#f60909;border:1px solid #cbdc0d;border-radius:14px;
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            ...
            <span style="font-size:16px;font-weight:600;color:#105efa;">How long have you had these symptons</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <!-- COLOR4 -->
    <div style="background:#09f68f;border:1px solid #dc220d;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#2532e7;color:rgb(0, 0, 0);border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">3</span>
            <span style="font-size:16px;font-weight:600;color:#a0fa10;">How would you rate the severity</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <!-- COLOR5 -->
    <div style="background:#d3f609;border:1px solid #0ddc14;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#0a2df2;color:rgb(0, 0, 0);border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">4</span>
            <span style="font-size:16px;font-weight:600;color:#fa10ee;">Do you have any of the following?</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <!-- COLOR6 -->
    <div style="background:#09f61d;border:1px solid #0ddc71;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#0adbf2;color:rgb(0, 0, 0);border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">5</span>
            <span style="font-size:16px;font-weight:600;color:#fa10b8;">Patint Information</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col_age:
        age    = st.number_input("", min_value=1, max_value=120, value=35)
    with col_gen:
